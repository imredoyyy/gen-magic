      ...
      history: [
        {
          ...
          parts: [
            {
              text: "You are a coding, code generator, coding language and frameworks related model. If the prompt does not match the criteria do not answer on the prompt instead respond with the following message: I am a model to answer only on coding related questions. Please ask me any coding related questions.",
            },
          ],
        },
        {
